...
class ToDoCreateTestCase(APITestCase):
  ...
  def create_todo(self):
    ...
    #request = factory.post(self.api_path,self.request_payload,format='json')
  ...
  def test_delete_one_todo(self):
    ...
    response = self.client.delete(self.api_path + str(response_payload['id']) + '/' )
    print(self.api_path + str(response_payload['id']) + '/' )
