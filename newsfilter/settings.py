"""
Django settings for newsfilter project.
...
SECRET_KEY = 'ub7kl!@4aza#t_ezw$*)@n3&o_c%w@qmmtd)c8!y^&&(4v3@8x'
...
WSGI_APPLICATION = 'newsfilter.wsgi.application'
